...
const defaultKAINamespace = "kai-scheduler"
...
func (c *ConfigSpec) SetDefaultsWhereNeeded() {
	if len(c.Namespace) == 0 {
		c.Namespace = defaultKAINamespace
	}
	if c.Global == nil {
	...
	if c.PodGrouper == nil {
		c.PodGrouper = &pod_grouper.PodGrouper{}
	}
	c.PodGrouper.SetDefaultsWhereNeeded(c.Global.ReplicaCount)

	if c.Binder == nil {
		c.Binder = &binder.Binder{}
	}
	...
	if c.NodeScaleAdjuster == nil {
		c.NodeScaleAdjuster = &node_scale_adjuster.NodeScaleAdjuster{}
	}

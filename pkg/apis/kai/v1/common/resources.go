...
type ResourceRecommendation string

const (
	ResourceRecommendationSmall  ResourceRecommendation = "small"
	ResourceRecommendationMedium ResourceRecommendation = "medium"
	ResourceRecommendationLarge  ResourceRecommendation = "large"
)
